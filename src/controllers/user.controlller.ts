...
export const getUsersController = async (
  ...
  try {
    ...
    logger.error(`getUsersController UserController Error: ${error.message}`);
...
export const getUserController = async (
  ...
  try {
    ...
    logger.error(`getUserController UserController Error: ${error.message}`);
    return next(new (CustomException as any)(500, 'Operation unsuccessful'));
  }
};
...
export const updateUserController = async (
  ...
  try {
    ...
    logger.error(`updateUserController UserController Error: ${error.message}`);
    return next(new (CustomException as any)(500, 'Operation unsuccessful'));
  }
};
...
export const deleteUserController = async (
  ...
  try {
    ...
    logger.error(`deleteUserController UserController Error: ${error.message}`);
    return next(new (CustomException as any)(500, 'Operation unsuccessful'));
  }
};
